    ...
    // @downloadURL  https://github.com/wololo-wololo/r4echatemotes/raw/main/really-cool-emojis.user.js
    // @updateURL    https://github.com/wololo-wololo/r4echatemotes/raw/main/really-cool-emojis.user.js
      ...
      async function setEmotes() {
        try {
          emotes = await fetchJSON(
            "https://github.com/wololo-wololo/r4echatemotes/main/emojis.json"
          );
          makeMenu();
          orderEmotes();
        } catch (error) {
